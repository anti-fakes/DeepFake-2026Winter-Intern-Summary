...
## 용어 정의
1. **TP** → 사람의 눈으로 판단되는 공통적인 부분이 존재하는가?
2. **FN** → Hard Sample에서 공통적으로 드러나는 주파수 or 픽셀 흔적이 존재하는가?
3. **FP** → 공통적인 질감, 구조, 형태가 존재하는가?
4. **TN** → 공통적인 이미지의 주제나 의미가 존재하는가?
---
...
## 2. 시각적 유사도(Artifact) 분석 (ResNet-50 + t-SNE)
...
# 추가실험(T21-based Image Only)
## 배경 및 목적
Hard Sample에 포함된 Wild 데이터는 압축에 따른 변화가 존재하기에 GPT, Z-image의 T2I모델의 분석 결과와 다른 경향성을 보일 수 있다. 
해서 Wild data를 제외한 GPT, Z-imamge의 Hard Sample만으로 위의 동일한 분석을 추가로 진행 

## 실험 결과 
### 1. 주파수 분석 
| Hard Sample(Original) | Hard Sample(GPT + Z-image) |
|:---:|:---:|
| <img src="https://github.com/user-attachments/assets/c4fcb51b-2a6f-471e-b400-e675213e0b08" height="325"> | <img src="https://github.com/user-attachments/assets/d517c125-1c6e-49db-89a3-0ab9e6cffd00" height="325"> |
- 주파수 평균은 비슷한 분포를 보이는 것을 확인할 수 있다.

| Hard Sample(Original) | Hard Sample(GPT + Z-image) |
|:---:|:---:|
| <img src="https://github.com/user-attachments/assets/75d29958-8fcc-4bd8-b1d8-905eb5091b8d" height="350"> | <img src="https://github.com/user-attachments/assets/e346a372-6a5e-4a2f-9d5c-41f921bfb2b8" height="350"> |
- 고주파수 영역에서(x축의 오른쪽) wild data를 제거한 이후 FN(Hard Sample)값이 내려가는 것을 확인할 수 있다.


### 2. 시각적 유사도(Artifact) 분석 (ResNet-50 + t-SNE)
| Hard Sample(Original) | Hard Sample(GPT + Z-image) |
|:---:|:---:|
| <img src="https://github.com/user-attachments/assets/fdf9b074-b296-4cf7-b835-5469dab63313" height="350"> | <img src="https://github.com/user-attachments/assets/4fe09b1f-4c20-491f-b00b-506b1bc54c3b" height="350" > 
- Fake정탐(TP) Real정탐(TN) 영역의 사이에 존재하는 Hard Sample들이 대부분 Wild data임을 확인할 수 있음
- GPT, Z-image 기반의 Hard Sample들은 Fake 정탐(TP)의 영역의 반대쪽에 존재하는 것을 확인할 수 있다. 

### 3. 의미적 유사도 분석 (CLIP + UMAP)
| Hard Sample(Original) | Hard Sample(GPT + Z-image) |
|:---:|:---:|
| <img src="https://github.com/user-attachments/assets/c24ee5f3-a223-4deb-b0ed-be340c8ec43f"  height="350"> | <img src="https://github.com/user-attachments/assets/17b9ff87-6a6c-419f-99d4-e031b3c71084"  height="350"> 
- Hard Sample 중에서도 Wild data의 의미적인 분포가 훨씬 더 다양하게 퍼져있는 것을 확인할 수 있다.
